...
class RadioControllerImplTest {
    ...
    fun setDeviceAddressSkipsSwitchWhenAddressUnchanged() = runTest {
        ...
        every { radioInterfaceService.setDeviceAddress("tcp:192.168.1.1") } returns true
    ...
    @Test
    fun setDeviceAddressDoesNotPersistOrReportSuccessWhenSameAddressIsRejected() = runTest {
