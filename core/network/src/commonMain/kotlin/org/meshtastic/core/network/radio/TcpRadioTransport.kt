...
internal constructor(
    ...
    override fun start() {
        lifecycle.runIfOpen { transport.start(address) }
    }
    ...
    override suspend fun close() {
        ...
        check(
            ...
            "[$address] TCP teardown did not complete within its lifecycle bounds"
        }
            ...
            try {
                val job =
                    scope.handledLaunch {
                        ...
                        if (!completed) Logger.w { "[$address] TCP $operation timed out after $OPERATION_TIMEOUT" }
                    }
